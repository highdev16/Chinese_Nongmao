...
?>
  ...
  <body class="u-body" style='overflow-x: hidden' oncontextmenu='return false' onkeydown="return checkKey(event)" onkeyup="return checkKey(event)">
