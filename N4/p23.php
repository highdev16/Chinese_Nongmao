  ...
  .u-section-2 {
    ...
    <section class="u-clearfix u-image u-section-6" id="sec-9ca0" data-image-width="3491" data-image-height="1234">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <p class="u-align-center u-text u-text-body-alt-color u-text-default u-text-3" style='background-image: url("/N4/images/itemlist.png"); width: 652px; height: 74px; line-height: 74px'> 政府合作方式一：我们投资，政府提供项目 </p>
        <p class="u-align-center u-text u-text-body-alt-color u-text-default u-text-4" style='background-image: url("/N4/images/itemlist.png"); width: 652px; height: 74px; line-height: 74px'> 政府合作方式二：我们投资，政府提供补助 </p>
      </div>
    </section>
