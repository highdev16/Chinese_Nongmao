		...
		<div class="main">
			...
			<?php
				...
				foreach ($arr as $i => $v) {
					...
					$htmlString .= "<tr id='r_$row'><td style='background-color:#eee'>$no</td><td style='background-color:#eee'><span style='color:#999'>" . $text . "</span><br><b>" . htmlspecialchars($url) . "</b></td><td><textarea placeholder='无内容' class='title'>"
